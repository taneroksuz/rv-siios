    ...
    if (hardware == 1) begin : rom_hardware
      ...
      always_ff @(posedge clock) begin
        case (raddr)
          ...
          6'b100001: rdata <= 32'h17E30FF0;
          6'b100010: rdata <= 32'h8E83FFFF;
          6'b100011: rdata <= 32'h00230002;
          6'b100100: rdata <= 32'h030501D3;
          6'b100101: rdata <= 32'hD4630385;
          6'b100110: rdata <= 32'h007301C3;
          6'b100111: rdata <= 32'h00B73020;
          6'b101000: rdata <= 32'h80678000;
          6'b101001: rdata <= 32'h00010000;
